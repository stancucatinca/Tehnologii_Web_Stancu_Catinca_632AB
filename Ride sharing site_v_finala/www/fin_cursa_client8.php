...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // --- SCHIMBARE AICI ---
    // Statusul trebuie să fie 'finalizata' (așa e în ENUM-ul tău)
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .finish-box h2 { color: var(--primary); text-align: center; font-size: 1.7rem; margin-bottom: 1.5rem; }
...
<body>
  <div class="finish-box">
    ...
    <form action="" method="POST">
        ...
        <button type="submit" class="finish-btn">Finalizează cursa</button>
    </form>
