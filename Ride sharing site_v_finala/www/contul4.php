...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $model_masina = isset($_POST['model_masina']) ? $_POST['model_masina'] : ''; // Aici e cheia
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .account-box h2 { margin-bottom: 1.5rem; font-size: 2rem; color: var(--primary); }
    ...
    <div class="account-box">
      ...
      <div class="back-link">
        <?php if($user['rol'] == 'sofer'): ?>
             <a href="sofer_comanda9.php">← Înapoi la comenzi</a>
        <?php else: ?>
             <a href="PP3.php">← Înapoi la comandă</a>
        <?php endif; ?>
      </div>
    </div>
  </div>

  <button id="top-btn">⬆️</button>
